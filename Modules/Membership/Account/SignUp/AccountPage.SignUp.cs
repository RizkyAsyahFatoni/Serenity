...
using Serintest.Administration;
using Serintest.Administration.Entities;
using Serintest.Administration.Repositories;
using Serintest.Common;
using Serenity;
using Serenity.Data;
...
namespace Serintest.Membership.Pages
{
